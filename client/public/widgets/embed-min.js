!(function (n,) {
  ...
  (function () {
    ...
    (d.className = "nf-popup"), p.appendChild(d)
    let c = !1, l = null
    ...
    (s.className = "nf-emoji"),
      ...
      (s.onclick = () => {
        c || ((l = document.createElement("iframe")), (l.src = e), (l.title = "Forms Mentorfy"), (l.style.maxWidth = `${a}px`), d.appendChild(l), (c = !0)), p.classList.toggle("open")
      }),
      p.appendChild(s),
